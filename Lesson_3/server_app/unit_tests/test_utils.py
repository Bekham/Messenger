...
from common_server.variables import RESPONSE, ERROR, USER, ACCOUNT_NAME, TIME, ACTION, PRESENCE, ENCODING
...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        self.test_messenger.message = self.test_dict_send
        # вызов тестируемой функции, результаты будут сохранены в тестовом сокете
        self.test_messenger.send_message(test_socket)
        ...
        with self.assertRaises(Exception):
            self.test_messenger.message = test_socket
            self.test_messenger.send_message(test_socket)
    ...
    def test_get_message(self):
        ...
        self.assertEqual(self.test_messenger.get_message(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(self.test_messenger.get_message(test_sock_err), self.test_dict_recv_err)
