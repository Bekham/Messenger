...
import server_app.logs_server.config_server_log
...
class Log:
    ...
    def __call__(self, func_to_log):
        def log_saver(*args, **kwargs):
            ...
            LOGGER.debug(
                f'Была вызвана функция {func_to_log.__name__} c параметрами {args_kwargs}. '
...
def login_required(func):
    ...
    def checker(*args, **kwargs):
        ...
        from server_app.common_server.core_server import MessengerServerCore
        from server_app.common_server.variables import ACTION, PRESENCE
